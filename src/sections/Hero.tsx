  ...
  return (
    <section id="hero" className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        <p className="text-[#00d4ff] text-xs md:text-sm font-medium uppercase tracking-[0.2em] mb-6"
          style={{ animation: 'fadeInUp 0.6s ease-out 0.2s both' }}>
          Semiconductor Failure Analysis Learning
        </p>
        <h1 className="text-[#f1f5f9] font-bold leading-[1.1] tracking-tight mb-6"
          style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', animation: 'fadeInUp 0.8s ease-out 0.4s both' }}>
          半导体失效分析<br />学习平台
        </h1>
        <p className="text-[#94a3b8] text-base md:text-lg leading-relaxed max-w-xl mx-auto mb-10"
          style={{ animation: 'fadeInUp 0.6s ease-out 0.7s both' }}>
          从基础理论到核心设备原理，从典型流程到真实案例，系统学习半导体失效分析的核心知识
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4"
          ...
          <button onClick={() => handleClick('#cases')}
